...
public class Grid : View
{
    ...
    protected virtual bool ExecuteDrawGridChild(DrawDraw draw, GridChild child)
    {
        ...
        long lite;
        long nite;
        lite = this.GridPosCol(startCol);
        nite = this.GridPosRow(startRow);
        long col;
        long row;
        ...
        long rite;
        long site;
        rite = this.GridPosCol(endCol);
        site = this.GridPosRow(endRow);
    ...
    protected virtual long GridPosCol(long col)
    {
        return this.GridPosPixelPos(col, 0);
    }

    protected virtual long GridPosRow(long row)
    {
