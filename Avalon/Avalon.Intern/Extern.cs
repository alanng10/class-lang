...
public static class Extern
{
    ...
    [DllImport(InfraLib)] public extern static ulong Time_AddMin(ulong o, ulong offset);
    [DllImport(InfraLib)] public extern static ulong Time_AddSec(ulong o, ulong offset);
    [DllImport(InfraLib)] public extern static ulong Time_AddMillisec(ulong o, ulong offset);
