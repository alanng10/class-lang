...
Infra_Api Int TextEncode_ExecuteCount(Int o, Int innKind, Int outKind, Int data);
Infra_Api Int TextEncode_ExecuteResult(Int o, Int result, Int innKind, Int outKind, Int data);
