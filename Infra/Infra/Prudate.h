...
Infra_Api Int TextEncode_ExecuteCount(Int o, Int innKnud, Int outKind, Int data);
Infra_Api Int TextEncode_ExecuteResult(Int o, Int result, Int innKnud, Int outKind, Int data);
...
Infra_Api Int Time_AddHour(Int o, Int value);
...
Infra_Api Int Stat_CompDestination(Int o);
Infra_Api Int Stat_CompSourceIn(Int o);
Infra_Api Int Stat_CompDestinationIn(Int o);
Infra_Api Int Stat_CompSourceOut(Int o);
Infra_Api Int Stat_CompDestinationOut(Int o);
Infra_Api Int Stat_CompSourceAtop(Int o);
