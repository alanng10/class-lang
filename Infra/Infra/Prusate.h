...
Infra_Api Int Slash_WidthSet(Int o, Int value);
...
Infra_Api Int Stat_SlashCapFlat(Int o);
Infra_Api Int Stat_SlashCapSquare(Int o);
Infra_Api Int Stat_SlashCapRound(Int o);
