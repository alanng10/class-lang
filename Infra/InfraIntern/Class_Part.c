...
Int Intern_Intern_MaideCall[15] = 
{ 
    CastInt(Intern_Intern_Init),
    CastInt(Intern_Intern_Memory),
    ...
    CastInt(Intern_Intern_ArrayNew),
    CastInt(Intern_Intern_ArrayGet),
    CastInt(Intern_Intern_ArraySet),
    CastInt(Intern_Intern_RefLess),
    CastInt(Intern_Intern_ThisThread)
};