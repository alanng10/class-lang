...
public class Create : InfraCreate
{
    ...
    public virtual Node ExecuteMaide(Range range)
    {
        ...
        Token leftBracket;
        leftBracket = this.TokenForwardNoSkip(this.TokenB, this.Limit.BraceLite.Text, this.Range(this.RangeA, maideToken.Range.End, end));
        if (leftBracket == null)
        {
            return null;
        }
        ...
        Token rightBracket;
        rightBracket = this.TokenMatchBraceLite(this.TokenC, this.Range(this.RangeA, leftBracket.Range.End, end));
    ...
    public virtual Node ExecuteCastOperate(Range range)
    {
        ...
        Token leftBracket;
        leftBracket = this.TokenForwardNoSkip(this.TokenB, this.Limit.BraceLite.Text, this.Range(this.RangeA, castToken.Range.End, end));
        if (leftBracket == null)
        {
            return null;
        }
    ...
    public virtual Node ExecuteBraceOperate(Range range)
    {
        ...
        Token leftBracket;
        leftBracket = this.Token(this.TokenA, this.Limit.BraceLite.Text, this.IndexRange(this.RangeA, start));
        if (leftBracket == null)
        {
            return null;
        }
    ...
    protected virtual Node ExecuteWordBracketBody(NodeKind kind, Index word, Range range)
    {
        ...
        Token leftBracket;
        leftBracket = this.Token(this.TokenB, this.Limit.BraceLite.Text, this.IndexRange(this.RangeA, wordToken.Range.End));
        if (leftBracket == null)
        {
            return null;
        }
    ...
    protected virtual Node ExecuteDotMaideCall(NodeKind kind, Range range)
    {
        ...
        Token leftBracket;
        leftBracket = this.TokenMatchBraceRite(this.TokenB, this.Range(this.RangeA, start, rightBracket.Range.Start));
        if (leftBracket == null)
        {
            return null;
        }
    ...
    protected virtual long ForwardSkipBracket(long index, long end)
    {
        ...
        {
            Token rightBracket;
            rightBracket = this.TokenMatchBraceLite(this.TokenA, this.Range(this.RangeA, index + 1, end));
            if (!(rightBracket == null))
            {
    ...
    protected virtual long BackwardSkipBracket(long index, long start)
    {
        ...
        {
            Token leftBracket;
            leftBracket = this.TokenMatchBraceRite(this.TokenA, this.Range(this.RangeA, start, t));
            if (!(leftBracket == null))
            {
