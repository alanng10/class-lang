...
public class Test : ClassBase
{
    ...
    private bool AddSetUnitList()
    {
        ...
        while (kindIter.Next())
        {
            ...
            while (unitIter.Next())
            {
                ...
                String expect;                
                expect = this.ClassInfra.StorageTextReadAny(expectFile, true);
                ...
                if (this.Set.AddPathAfterTaskArg)
                {
                    ...
                    path = this.ClassInfra.StorageTextReadAny(pathFile, true);
                }
    ...
    private bool ExecuteUnit()
    {
        ...
        this.ClassInfra.StorageTextWriteAny(actualFile, actual, true);
